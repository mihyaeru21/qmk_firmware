...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,       KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,  KC_DEL,
                          KC_HOME,  KC_END,                                        KC_PGDN, KC_PGUP,
                                             KC_SPC, KC_LCTL,              KC_ENT,
                                              LOWER, KC_LALT,             KC_BSPC,
                                            KC_LGUI,  KC_ESC,    T_LOWER,   RAISE
    ),
    ...
    [_RAISE] = LAYOUT(
        ...
        _______, _______, _______,   KC_UP, KC_PGUP, KC_PGDN,    _______, _______, _______, _______, _______, _______, _______,
